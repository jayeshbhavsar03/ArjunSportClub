...
if(isset($_POST['order_btn'])){
   ...
   $address = mysqli_real_escape_string($conn, 'flat no. '. $_POST['addr'].', '. $_POST['city'].', '. $_POST['country'].' - '. $_POST['pin_code']);
         ...
         mysqli_query($conn, "INSERT INTO `cricket_enroll`(user_id, sp_name, name, number, email, method_plans, gender, dob, JoinDate, address) VALUES('$user_id', '$sp_name', '$name', '$number', '$email', '$method_plans', '$gender', '$dob', '$JoinDate', '$address')") or die('query failed');
